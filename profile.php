    ...
    <section class="user-info">
        <div class="user-info-column">
            <form action="profile_proccess.php" method="POST" class="data-group">
                ...
                <div class="input-field-group">
                    <input type="text" class="form-inputs" id="user" name="user" value="<?=$userData->user?>" readonly>
            ...
            <form action="profile_proccess.php" method="POST" class="data-group">
                ...
                <div class="input-field-group">
                    <input type="text" class="form-inputs" id="email" name="email" value="<?=$userData->email?>" readonly>
                    <img src="img/icons/pencil-solid.svg" alt="" class="change-pencil">
                    <button type="submit" class="confirm-change">
                        <img src="img/icons/check-solid.svg" alt="" >
                    </button>
        ...
        <div class="user-info-column">
            <form action="profile_proccess.php" method="POST" class="data-group">
                ...
                <div class="input-field-group">
                    <input type="password" class="form-inputs" id="password" name="password" value="" readonly>
                ...
                <div id="new-pass-group">
                    ...
                    <input type="password" class="form-inputs" id="passwordConf" name="passwordConf" value="">
                </div>
                <div id="conf-new-pass-group">
                    <label for="newPasswordConf">Confirm</label>
                    <input type="password" class="form-inputs" id="newPasswordConf" name="newPasswordConf" value="">
                </div>
            </form>
            <form action="profile_proccess.php" method="POST" class="data-group">
                <input type="hidden" name="id" value="<?=$userData->id?>">
                ...
                <div class="input-field-group">
                    <input type="text" class="form-inputs" id="nationality" name="nationality" value="<?=$userData->nationality?>" readonly>
                    <img src="img/icons/pencil-solid.svg" alt="" class="change-pencil">
                    <button type="submit" class="confirm-change">
                        <img src="img/icons/check-solid.svg" alt="" >
                    </button>
